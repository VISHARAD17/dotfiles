...
hi("@character", { fg = colors.yellow })
hi("@number", { fg = colors.yellow })
hi("@number.float", { fg = colors.yellow })
hi("@boolean", { fg = colors.cyan })
hi("@comment", { fg = colors.gray90 })
...
hi("@label", { fg = colors.yellow })
hi("@keyword", { fg = colors.cyan })
hi("@keyword.modifier", { fg = colors.cyan })
hi("@keyword.type", { fg = colors.cyan })
hi("@keyword.operator", { fg = colors.cyan })
hi("@keyword.import", { fg = colors.cyan })
hi("@keyword.return", { fg = colors.cyan })
hi("@keyword.exception", { fg = colors.cyan })
hi("@function", { fg = colors.yellow })
...
hi("@operator", { fg = colors.cyan })
hi("@punctuation.bracket", { fg = colors.gray120 })
hi("@punctuation.delimiter", { fg = colors.gray120 })
